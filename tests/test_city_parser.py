...
def test_aggregate_daily_weather_summarizes_city_day_metrics():
    frame = pd.DataFrame(
        [
            {
                "city": "New York",
                "time": pd.Timestamp("2026-09-03 00:00:00"),
                "temperature_2m": 21.5,
                "precipitation": 0.2,
            },
            {
                "city": "New York",
                "time": pd.Timestamp("2026-09-03 01:00:00"),
                "temperature_2m": 23.0,
                "precipitation": 0.8,
            },
            {
                "city": "New York",
                "time": pd.Timestamp("2026-09-04 00:00:00"),
                "temperature_2m": 19.5,
                "precipitation": 1.1,
            },
            {
...
def test_aggregate_daily_weather_handles_missing_values_and_sorts_output():
    frame = pd.DataFrame(
        [
            {
                "city": "Paris",
                "time": pd.Timestamp("2026-09-05 10:00:00"),
                "temperature_2m": None,
                "precipitation": 0.6,
            },
            {
                "city": "Paris",
                "time": pd.Timestamp("2026-09-05 11:00:00"),
                "temperature_2m": 27.5,
                "precipitation": None,
            },
            {
                "city": "Berlin",
                "time": pd.Timestamp("2026-09-05 09:00:00"),
                "temperature_2m": 19.0,
                "precipitation": 0.3,
            },
            {
